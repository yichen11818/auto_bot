...
def Box3_4(n):         #3号码到4号码
    for i in range(0, n):
        base_action.action("Box_Right2_go8s")
        time.sleep(0.5)


def Box4_5(n):   #4号码到5号码
    for i in range(0, n):
        base_action.action("Box_Left4_go6s")#
        time.sleep(0.5)
def Box6_7(n):      #6号码到7号码
    for i in range(0, n):
        base_action.action("Left4_go6s")
        time.sleep(0.5)
...
def Box_pct(n):     #5号码到终点转身放下箱子
    for i in range(0, n):
        base_action.action("Box_go6s_pctgai2")
        time.sleep(0.5)
...
def box_go1(n):  # 抱着箱子前进一步
    for i in range(0, n):
        base_action.action("BoxForward1-1")
        time.sleep(1)
    ...
    if chest_circle_x is None:
        ...
        if chest_circle_x < 275:
            ...
            if chest_circle_y < 300:
                ...
                base_action.action("Forwalk01")
                base_action.action("Forwalk01")
                base_action.action("Getcubegai1")
                level = "end_box"
