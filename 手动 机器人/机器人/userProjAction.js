...
Blockly.Lua['1721308540232'] = function(block) {
  let code = "MOTOrigid16(40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40)\n\n\n-- 张\nMOTOsetspeed(30)\nMOTOmove19(80,50,149,100,93,55,124,100,120,150,50,100,107,145,76,100,128,71,100)\nMOTOwait()\nMOTOsetspeed(20)\nMOTOmove19(80,50,149,100,136,150,62,100,120,150,50,100,72,50,138,100,128,71,100)\nMOTOwait()\nMOTOsetspeed(10)\nMOTOmove19(80,50,149,100,149,150,58,100,120,150,50,100,52,50,142,100,128,71,100)\nMOTOwait()\nMOTOsetspeed(30)\nMOTOmove19(60,17,149,100,149,150,67,100,141,183,49,100,40,50,133,100,128,78,100)\nMOTOwait()\nMOTOsetspeed(30)\nMOTOmove19(60,17,149,100,104,132,70,100,141,189,49,100,93,69,130,100,128,78,100)\nMOTOwait()\nMOTOsetspeed(20)\nMOTOmove19(60,17,149,100,90,55,127,100,141,189,49,100,110,145,73,100,127,78,100)\nMOTOwait()\n";
  return code;
}

Blockly.Python['1721308540232'] = function(block) {
  let code = "robot.leju_action('抱1')\n";
  return code;
}

Blockly.Blocks['1721309338451'] = {
  init: function() {
    this.jsonInit({
      "type": "1721309338451",
      "message0": "右转变慢",
...
Blockly.Lua['1721309338451'] = function(block) {
  let code = "MOTOrigid16(30,30,30,65,65,65,65,65,30,30,30,65,65,65,65,65)\nMOTOsetspeed(20)\nMOTOmove19(48,18,149,99,130,43,173,106,142,180,57,98,144,140,118,107,127,78,101)\nMOTOwait()\nMOTOsetspeed(40)\nMOTOmove19(47,18,149,99,90,55,124,100,142,179,56,98,107,145,76,100,127,78,107)\nMOTOwait()\n";
  return code;
}

Blockly.Python['1721309338451'] = function(block) {
  let code = "robot.leju_action('右转变慢')\n";
  return code;
}
...
Blockly.Lua['1724089330847'] = function(block) {
  let code = "MOTOrigid16(40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40)\n\n\n-- RIGEND\nMOTOsetspeed(20)\nMOTOmove19(73,10,158,100,93,55,127,100,134,190,51,100,107,145,73,100,128,71,100)\nMOTOwait()\nMOTOsetspeed(20)\nMOTOmove19(73,10,158,100,111,150,50,102,134,190,51,100,88,51,153,101,128,71,100)\nMOTOwait()\nMOTOsetspeed(10)\nMOTOmove19(64,18,154,98,160,148,65,100,120,189,53,99,40,53,133,99,128,71,99)\nMOTOwait()\n\n\n-- 松手\nMOTOsetspeed(10)\nMOTOmove19(80,33,130,101,107,149,43,100,120,165,66,101,92,51,157,100,128,71,100)\nMOTOwait()\n\n\n-- 站立\nMOTOsetspeed(20)\nMOTOmove19(80,30,100,100,93,55,124,100,120,170,100,100,107,145,76,100,128,71,100)\nMOTOwait()\n";
  return code;
}

Blockly.Python['1724089330847'] = function(block) {
  let code = "robot.leju_action('放下备用新')\n";
  return code;
}

Blockly.Blocks['1724089878780'] = {
  init: function() {
    this.jsonInit({
      "type": "1724089878780",
      "message0": "前进备用",
...
Blockly.Lua['1724089878780'] = function(block) {
  let code = "MOTOrigid16(40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40)\nMOTOsetspeed(6)\nMOTOmove19(73,10,158,95,91,48,134,80,134,190,51,98,109,146,71,89,128,71,100)\nMOTOwait()\nMOTOsetspeed(30)\nMOTOmove19(73,10,158,95,123,95,115,90,134,190,51,98,109,146,71,87,128,71,100)\nMOTOwait()\nDelayMs(500)\nMOTOsetspeed(30)\nMOTOmove19(73,10,158,95,121,37,161,88,134,190,51,98,109,146,72,89,128,71,100)\nMOTOwait()\nMOTOsetspeed(10)\nMOTOmove19(73,10,158,107,98,56,129,111,134,190,51,112,131,155,88,110,128,71,100)\nMOTOwait()\nMOTOrigid16(40,40,40,70,70,70,70,70,40,40,40,70,70,70,70,70)\nMOTOsetspeed(30)\nMOTOmove19(73,10,158,100,93,54,128,113,134,190,51,114,77,105,85,110,128,71,100)\nMOTOwait()\nMOTOsetspeed(30)\nMOTOmove19(73,10,158,106,91,54,128,111,134,190,51,114,89,163,39,112,128,71,100)\nMOTOwait()\nMOTOsetspeed(10)\nMOTOmove19(73,10,158,95,69,45,112,90,134,190,51,98,102,144,71,89,128,71,100)\nMOTOwait()\nMOTOrigid16(40,40,40,70,70,70,70,70,40,40,40,70,70,70,70,70)\nMOTOsetspeed(30)\nMOTOmove19(73,10,158,95,123,95,115,90,134,190,51,98,107,146,72,87,128,71,100)\nMOTOwait()\nDelayMs(300)\nMOTOsetspeed(30)\nMOTOmove19(73,10,158,100,91,55,129,87,134,190,51,100,109,145,71,90,128,71,100)\nMOTOwait()\nMOTOsetspeed(15)\nMOTOmove19(73,10,158,100,91,55,129,100,134,190,51,100,109,145,71,100,128,71,100)\nMOTOwait()\n";
  return code;
}

Blockly.Python['1724089878780'] = function(block) {
  let code = "robot.leju_action('前进备用')\n";
  return code;
}
...
Blockly.Lua['1724483758737'] = function(block) {
  let code = "MOTOrigid16(40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40)\nMOTOsetspeed(40)\nMOTOmove19(73,10,158,100,50,40,100,93,134,190,51,100,75,146,43,95,127,78,100)\nMOTOwait()\nMOTOsetspeed(40)\nMOTOmove19(73,10,158,100,90,55,127,100,134,190,51,100,110,145,73,100,127,78,100)\nMOTOwait()\n";
  return code;
}

Blockly.Python['1724483758737'] = function(block) {
  let code = "robot.leju_action('左转智能')\n";
  return code;
}
