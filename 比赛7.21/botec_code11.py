...
# 不同色块的hsv范围
color_range = {
    'green': [( 48 , 102 , 99 ),( 65 , 191 , 137 )],
    'orange': [( 23 , 122 , 111 ),( 29 , 255 , 155 )]
}
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        if ID == 0:  # 搬箱子  
            if level == "start_box":
                green_have = colour_port.have_color('chest',48 , 102 , 99 , 65 , 191 , 137)
                orange_percent = colour_port.get_color_percent('chest', 23 , 122 , 111 ,29 , 255 , 155)
